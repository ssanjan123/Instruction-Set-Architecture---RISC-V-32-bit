...
tests_json = """{
  ...
  "Custom": {
    "Part1": {
      "./riscv -d ./code/input/custom.input > ./code/out/custom.solution": 0,
      "diff ./code/out/custom.solution ./code/ref/custom.solution": 30
    },
    "Part2": {
      "timeout 60 ./riscv -r ./code/input/custom.input > ./code/out/custom.trace": 0,
      "diff ./code/out/custom.trace ./code/ref/custom.trace": 30
    }
  },
  "All": {
    "Part1": {
