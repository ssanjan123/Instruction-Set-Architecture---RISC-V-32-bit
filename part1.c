...
void write_mac(Instruction instruction){
...
void print_lui(Instruction instruction) {//load upper immediate (20 bits)
    /* YOUR CODE HERE */
    printf(LUI_FORMAT,instruction.ujtype.rd,instruction.utype.imm);
}

void print_jal(Instruction instruction) {//saves the next address (program counter +4) to the destination register, adds the immediate value encoded in the instruction to the program counter, and jumps to that address
    /* YOUR CODE HERE */
